...
import { ArrowUpRight, TrendingUp, Heart, DollarSign, Calendar, ExternalLink, Download, X, Wallet, CheckCircle2, Loader2 } from "lucide-react"
...
export default function DashboardPage() {
  ...
  const handleWalletConnect = async (walletId: string) => {
    ...
    try {
      ...
      const truncatedAddress = `${randomAddress.slice(0, 6)}...${randomAddress.slice(-4)}`
