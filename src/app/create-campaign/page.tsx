            ...
            <CardContent className="space-y-4">
              <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                <p className="text-sm text-muted-foreground">
                  Creating a campaign requires blockchain interaction. Please
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Create a transparent, blockchain-powered fundraising campaign
          </p>
        </div>
              ...
              {currentStep === "funding-details" && (
                ...
                >
                  ...
                  <div className="flex justify-between pt-4">
                    ...
                    <Button
                      onClick={nextStep}
                      disabled={!formData.goal || !formData.endDate}
                    >
                      Continue
                      <ChevronRight className="ml-2 h-4 w-4" />
                    </Button>
              ...
              {currentStep === "media" && (
                ...
                >
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Upload images and videos to showcase your campaign
                    </p>
                  </div>
              ...
              {currentStep === "preview" && (
                ...
                >
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Review all details before deploying to the blockchain
                    </p>
                  </div>
              ...
              {currentStep === "deploy" && (
                ...
                >
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Your campaign will be deployed to the {formData.chain}{" "}
                      blockchain
                    </p>
                  </div>
                  ...
                  <div className="bg-muted/50 rounded-lg p-8 space-y-4">
                    <div className="w-20 h-20 mx-auto bg-primary/10 rounded-full flex items-center justify-center">
                      <img
                        src={
                          chains.find((c) => c.name === formData.chain)?.logo
                        }
                        alt={formData.chain}
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/50 rounded-lg p-4 text-left">
                    <p className="text-sm text-amber-700 dark:text-amber-400">
                      <strong>Important:</strong> Once deployed, your campaign
                      cannot be deleted. You will need to confirm this
              ...
              {currentStep === "success" && (
                ...
                >
                  ...
                  <div className="flex gap-3">
                    ...
                    <Link
                      href={`/campaign/${formData.contractAddress}`}
                      className="flex-1"
                    >
