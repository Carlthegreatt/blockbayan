...
const mockCampaigns = [
  {
    ...
    description: "Help provide educational materials and technology for underprivileged schools in Mindanao region.",
    category: "Education",
    goal: "50 ETH",
    raised: "32.5 ETH",
    percentage: 65,
    ...
    image: "https://mindanews.com/wp-content/uploads/2024/07/CLASSES-DAVAO-CITY-NHS.jpg",
  },
  {
    id: "2",
    ...
    image: "https://files01.pna.gov.ph/category-list/2022/09/28/dswd-relief-ops-in-jomalig-quezonpic-courtesy-of-dswd.jpg",
  },
  {
    id: "3",
    ...
    image: "https://www.dai.com/uploads/LUCAB%20PWS%20(4).jpg",
  },
  {
    id: "4",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Discover campaigns and track global blockchain activity</p>
        </div>
        ...
        <Tabs defaultValue="campaigns" className="space-y-6">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        <div className="flex items-center justify-between text-sm mb-2">
                          <span className="font-semibold text-primary">{campaign.raised}</span>
          ...
          <TabsContent value="transactions" className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                <Input placeholder="Search by wallet, campaign, or tx hash..." className="pl-10" />
              </div>
              <div className="flex gap-2">
                <Button variant="outline" className="flex items-center gap-2">
                  <Filter className="h-4 w-4" />
                    ...
                    <tbody className="divide-y divide-border">
                      {mockTransactions.map((tx) => (
                        <tr key={tx.id} className="hover:bg-muted/50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <Link href={`/campaign/${tx.id}`} className="text-primary hover:underline">
                              {tx.campaign}
                            </Link>
                          </td>
                          <td className="px-6 py-4">
